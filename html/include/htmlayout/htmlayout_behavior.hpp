...
namespace htmlayout 
{
  ...
  inline HLDOM_RESULT attach_event_handler(HELEMENT he, event_handler* p_event_handler, UINT subscription = HANDLE_ALL )
  {
    return HTMLayoutAttachEventHandlerEx(he, &event_handler::element_proc, p_event_handler, subscription);
  }
  ...
  inline HLDOM_RESULT attach_event_handler(HWND hwndLayout, event_handler* p_event_handler, UINT subscription = HANDLE_ALL )
  {
    return HTMLayoutWindowAttachEventHandler(hwndLayout, &event_handler::element_proc, p_event_handler, subscription);
  }  
